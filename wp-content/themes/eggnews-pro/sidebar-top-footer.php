...
$footer_parallax = get_theme_mod('parallax_footer_eggnews');
?>
<div id="top-footer" class="footer-widgets-wrapper clearfix  <?php echo esc_attr( $eggnews_footer_layout ); ?>" style="<?php echo ($footer_parallax) ? 'background: transparent;': ''; ?>"> 
