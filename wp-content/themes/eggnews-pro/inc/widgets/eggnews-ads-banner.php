...
if (!class_exists('Eggnews_Ads_Banner')):
    ...
    class Eggnews_Ads_Banner extends WP_widget {
        ...
        public function __construct() {
            $widget_ops = array(
                ...
                'description' => __('You can place banner as advertisement with links.', 'eggnews-pro')
            );
            parent::__construct('eggnews_ads_banner', __('Banner Ad', 'eggnews-pro'), $widget_ops);
        }
        ...
        private function widget_fields() {
            ...
            $ads_size = array(
                'leaderboard' => __('Leaderboard (728x90)', 'eggnews-pro'),
                'large' => __('Large (300x250)', 'eggnews-pro')
            );
            $fields = array(
                'banner_title' => array(
                ...
                'banner_size' => array(
                    ...
                    'eggnews_widgets_title' => __('Ads Size', 'eggnews-pro'),
                ...
                'banner_image' => array(
                    ...
                    'eggnews_widgets_title' => __('Add Image', 'eggnews-pro'),
                    'eggnews_widgets_field_type' => 'upload',
                ),
                'banner_url' => array(
                    'eggnews_widgets_name' => 'banner_url',
                    'eggnews_widgets_title' => __('Add Url', 'eggnews-pro'),
                    'eggnews_widgets_field_type' => 'url'
                ),
                'banner_target' => array(
                    'eggnews_widgets_name' => 'banner_target',
                    'eggnews_widgets_title' => __('Open in new tab', 'eggnews-pro'),
                    'eggnews_widgets_field_type' => 'checkbox'
                ),
                'banner_rel' => array(
                    'eggnews_widgets_name' => 'banner_rel',
                    'eggnews_widgets_title' => __('Rel Attribute for URL Link', 'eggnews-pro'),
                    'eggnews_widgets_field_type' => 'checkbox'
                )
            );
                    ...
                    if (!empty($eggnews_banner_url)) {
                        ...
                        <a href="<?php echo esc_url($eggnews_banner_url); ?>"
                           ...
                           rel="<?php echo esc_attr($eggnews_banner_rel); ?>"><img
                                src="<?php echo esc_url($eggnews_banner_image); ?>" alt=""/></a>
                        <?php
                    } else {
                        ?>
                        <img src="<?php echo esc_url($eggnews_banner_image); ?>" alt=""/>
                    <?php
                }
                ?>
                </div>
