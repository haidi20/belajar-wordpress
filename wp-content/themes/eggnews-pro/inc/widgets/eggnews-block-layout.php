...
if ( ! class_exists( 'Eggnews_Block_Layout' ) ):
	...
	class Eggnews_Block_Layout extends WP_widget {
		...
		public function __construct() {
			$widget_ops = array(
				...
				'description' => __( 'Display posts in block layout', 'eggnews-pro' )
			);
			parent::__construct( 'eggnews_block_layout', __( 'Block Layout', 'eggnews-pro' ), $widget_ops );
		}
		...
		private function widget_fields() {
			...
			$fields = array(
				...
				'eggnews_block_cat_id'             => array(
					...
					'eggnews_widgets_title'          => __( 'Category for Block Layout', 'eggnews-pro' ),
				...
				'eggnews_block_category_parameter' => array(
					...
					'eggnews_widgets_title'         => esc_html__( 'Category Parameters for Block Layout', 'eggnews-pro' ),
				...
				'eggnews_block_tags'               => array(
					...
					'eggnews_widgets_title'          => esc_html__( 'Tags for Block Layout', 'eggnews-pro' ),
					'eggnews_widgets_default'        => 0,
					'eggnews_widgets_field_type'     => 'select',
				...
				'eggnews_block_tags_parameter'     => array(
					...
					'eggnews_widgets_title'         => esc_html__( 'Tags Parameters for Block Layout', 'eggnews-pro' ),
					'eggnews_widgets_default'       => 1,
					'eggnews_widgets_field_type'    => 'select',
                ...
                'eggnews_block_hide_comment'                      => array(
                    'eggnews_widgets_name'       => 'eggnews_block_hide_comment',
				...
				'eggnews_block_layout'             => array(
					...
					'eggnews_widgets_title'         => __( 'Layout Style', 'eggnews-pro' ),
		...
		public function widget( $args, $instance ) {
			...
			$eggnews_block_hide_category      = intval( empty( $instance['eggnews_block_hide_category'] ) ? null : $instance['eggnews_block_hide_category'] );
            ...
            $eggnews_block_hide_comment   = intval( empty( $instance['eggnews_block_hide_comment'] ) ? null : $instance['eggnews_block_hide_comment'] );
			...
			<div class="block-layout-wrapper">
				...
				switch ( $eggnews_block_layout ) {
					case 'layout2':
						$this->eggnews_block_layout_2( $eggnews_block_layout, $eggnews_block_cat_id, $eggnews_block_posts_count, $eggnews_block_category_parameter, $eggnews_block_tags, $eggnews_block_tags_parameter, $eggnews_block_hide_category, $eggnews_block_hide_post_date, $eggnews_block_hide_author, $eggnews_block_hide_comment);
						break;

					case 'layout3':
						$this->eggnews_block_layout_3( $eggnews_block_layout, $eggnews_block_cat_id, $eggnews_block_posts_count, $eggnews_block_category_parameter, $eggnews_block_tags, $eggnews_block_tags_parameter, $eggnews_block_hide_category, $eggnews_block_hide_post_date, $eggnews_block_hide_author, $eggnews_block_hide_comment );
						break;

					case 'layout4':
						$this->eggnews_block_layout_4( $eggnews_block_layout, $eggnews_block_cat_id, $eggnews_block_posts_count, $eggnews_block_category_parameter, $eggnews_block_tags, $eggnews_block_tags_parameter, $eggnews_block_hide_category, $eggnews_block_hide_post_date, $eggnews_block_hide_author, $eggnews_block_hide_comment );
						break;

					default:
						$this->eggnews_block_layout_default( $eggnews_block_layout, $eggnews_block_cat_id, $eggnews_block_posts_count, $eggnews_block_category_parameter, $eggnews_block_tags, $eggnews_block_tags_parameter, $eggnews_block_hide_category, $eggnews_block_hide_post_date, $eggnews_block_hide_author, $eggnews_block_hide_comment );
						break;
				}
				?>
		...
		public function eggnews_block_layout_2( $eggnews_block_layout, $eggnews_block_cat_id, $eggnews_block_posts_count, $eggnews_block_category_parameter, $eggnews_block_tags, $eggnews_block_tags_parameter, $eggnews_block_hide_category,$eggnews_block_hide_post_date, 
			$eggnews_block_hide_author, 
			$eggnews_block_hide_comment ) {
			?>
			<div
				class="block-posts-wrapper clearfix teg-column-wrapper <?php echo esc_attr( $eggnews_block_layout ); ?>">
				<?php
					...
					while ( $block_layout_query->have_posts() ) {
						...
						<div class="single-post-wrapper clearfix <?php echo esc_attr( $post_class ); ?>">
							...
							<div class="post-content-wrapper">
								<?php if (( $post_count == ( $total_post_left + 1 ) || $post_count == 1 ) && ( ! $eggnews_block_hide_category ) ) {
		...
		public function eggnews_block_layout_default( $eggnews_block_layout, $eggnews_block_cat_id, $eggnews_block_posts_count, $eggnews_block_category_parameter, $eggnews_block_tags, $eggnews_block_tags_parameter, $eggnews_block_hide_category,$eggnews_block_hide_post_date, 
			$eggnews_block_hide_author,
			$eggnews_block_hide_comment ) {
			?>
				...
				if ( $block_layout_query->have_posts() ) {
					while ( $block_layout_query->have_posts() ) {
						...
						<div class="single-post-wrapper clearfix <?php echo esc_attr( $post_class ); ?>">
							...
							<div class="post-content-wrapper">
								<?php if ( $post_count == 1 && ( ! $eggnews_block_hide_category ) ) {
									do_action( 'eggnews_post_categories' );
								} ?>
								<h3 class="post-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
								</h3>
		...
		public function eggnews_block_layout_3( $eggnews_block_layout, $eggnews_block_cat_id, $eggnews_block_posts_count, $eggnews_block_category_parameter, $eggnews_block_tags, $eggnews_block_tags_parameter, $eggnews_block_hide_category,$eggnews_block_hide_post_date, 
			$eggnews_block_hide_author,
			$eggnews_block_hide_comment ) {
			?>
			<div
		...
		public function eggnews_block_layout_4( $eggnews_block_layout, $eggnews_block_cat_id, $eggnews_block_posts_count, $eggnews_block_category_parameter, $eggnews_block_tags, $eggnews_block_tags_parameter, $eggnews_block_hide_category,$eggnews_block_hide_post_date, 
			$eggnews_block_hide_author,
			$eggnews_block_hide_comment ) {
			?>
			<div
		...
		public function update( $new_instance, $old_instance ) {
			...
			foreach ( $widget_fields as $widget_field ) {
				...
				$instance_value = isset( $new_instance[ $eggnews_widgets_name ] ) ? $new_instance[ $eggnews_widgets_name ] : null;
				// Use helper function to get updated field values
				$instance[ $eggnews_widgets_name ] = eggnews_widgets_updated_field_value( $widget_field, $instance_value );
			}
