...
if (!class_exists('Eggnews_Block_Column')):
    ...
    class Eggnews_Block_Column extends WP_Widget {
        ...
        public function __construct() {
            $widget_ops = array(
                ...
                'description' => __('Display block posts as Column layout.', 'eggnews-pro')
            );
            parent::__construct('eggnews_block_column', __('Column Block Posts', 'eggnews-pro'), $widget_ops);
        }
        ...
        private function widget_fields() {
            ...
            $fields = array(
                ...
                'eggnews_block_show_category' => array(
                    ...
                    'eggnews_widgets_title' => __('Show Category?', 'eggnews-pro'),
                    'eggnews_widgets_default' => 0,
                        ...
                        while ($block_column_query->have_posts()) {
                            ...
                            <div class="single-post-wrapper <?php echo esc_attr($post_class); ?> clearfix">
                                ...
                                <div class="post-content-wrapper">
                                    <?php
                                    if ($post_count == 1 && $eggnews_block_show_category) {
