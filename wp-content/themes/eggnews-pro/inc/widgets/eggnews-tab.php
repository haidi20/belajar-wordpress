 ...
 * @since 1.0.0
 */
add_action('widgets_init', 'eggnews_register_tab_widget');

function eggnews_register_tab_widget() {
    register_widget('Eggnews_Tab');
}

if (!class_exists('Eggnews_Tab')):

    class Eggnews_Tab extends WP_widget {
        ...
        public function __construct() {
            $widget_ops = array(
                ...
                'description' => __('Displays the latest posts, popular posts and the recent comments in tab.', 'eggnews-pro')
            );
            parent::__construct('eggnews_tab', __('Tab Widget', 'eggnews-pro'), $widget_ops);
        }
        ...
        private function widget_fields() {
            ...
            $fields = array(
                'banner_title' => array(
                    ...
                    'eggnews_widgets_title' => __('Number of posts to display.', 'eggnews-pro'),
                    'eggnews_widgets_field_type' => 'number',
                    'eggnews_widgets_default' => 5,
                ),
                'banner_rel' => array(
                    'eggnews_widgets_name' => 'show_post_by_view_count',
                    'eggnews_widgets_title' => __('Show popular post by view count.', 'eggnews-pro'),
            ...
            <div class="tab-widget">
                <ul class="widget-tabs">
                    <li class="tabs popular-tabs"><a
                            href="#popular"><?php _e('<i class="fa fa-star"></i>Popular', 'eggnews-pro'); ?></a></li>
                    <li class="tabs recent-tabs"><a
                            href="#recent"><?php _e('<i class="fa fa-history"></i>Recent', 'eggnews-pro'); ?></a></li>
                    <li class="tabs comment-tabs"><a
                            href="#comment"><?php _e('<i class="fa fa-comment"></i>Comment', 'eggnews-pro'); ?></a>
                    </li>
                </ul>
