...
function eggnews_metaboxes( $type, $post ) {
    add_meta_box(
        ...
        __( 'Sidebar Position', 'eggnews-pro' ),
...
function eggnews_sidebar_callback( $post ) {
    ...
    'default-sidebar' => array(
        ...
        'label'     => __( 'Default Layout', 'eggnews-pro' ),
        ),
    'right-sidebar' => array(
        'id'        => 'rigth-sidebar',
        'value'     => 'right_sidebar',
        'label'     => __( 'Right Sidebar', 'eggnews-pro' ),
        ),
    'left-sidebar' => array(
        'id'        => 'left-sidebar',
        'value'     => 'left_sidebar',
        'label'     => __( 'Left Sidebar', 'eggnews-pro' ),
        ),
    'no-sidebar-full-width' => array(
        'id'        => 'no-sidebar',
        'value'     => 'no_sidebar',
        'label'     => __( 'No Sidebar Full Width', 'eggnews-pro' ),
        ),
    'no-sidebar-content-centered' => array(
        'id'        => 'no-sidebar-center',
        'value'     => 'no_sidebar_center',
        'label'     => __( 'No Sidebar Content Centered', 'eggnews-pro' ),
        ),
    );
