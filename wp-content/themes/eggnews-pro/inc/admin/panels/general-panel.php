...
function eggnews_general_settings_register( $wp_customize ) {
	...
	$wp_customize->add_panel(
		...
		array(
			...
			'theme_supports' => '',
			'title'          => esc_html__( 'General Settings', 'eggnews-pro' ),
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'eggnews_theme_color',
			array(
				'label'    => esc_html__( 'Theme color', 'eggnews-pro' ),
				/*'description'   => __( 'Choose color to make different your website.', 'eggnews-pro' ),*/
				'section'  => 'colors',
				'priority' => 5
			)
		)
	...
	$wp_customize->add_section(
		'eggnews_site_layout',
		array(
			'title'       => esc_html__( 'Website Layout', 'eggnews-pro' ),
			'description' => esc_html__( 'Choose a site to display your website more effectively.', 'eggnews-pro' ),
			'priority'    => 5,
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'priority' => 10,
			'label'    => esc_html__( 'Site Layout', 'eggnews-pro' ),
			'section'  => 'eggnews_site_layout',
			'choices'  => array(
				'fullwidth_layout' =>esc_html__( 'Full Width Layout', 'eggnews-pro' ),
				'boxed_layout'     => esc_html__( 'Boxed Layout', 'eggnews-pro' )
			),
		)
	);		
}	
